...
```{r}
arr <- st_read("https://data.geopf.fr/wfs/ows?SERVICE=WFS&REQUEST=GetFeature&VERSION=2.0.0&typeName=CADASTRALPARCELS.PARCELLAIRE_EXPRESS:arrondissement") %>%
...
sf_conslyon <- st_as_sf(conslyon_coord,
...
con <-
  DBI::dbConnect(RPostgres::Postgres(),
                 host = "postgresql-990179.user-aubinpoissonnier",
                 dbname = "defaultdb",
...
df <- tbl(con, in_schema("dvf", "adresse"))
parc <- tbl(con, in_schema("dvf", "parcelle"))
```
